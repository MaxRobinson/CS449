...
class hidden_layer1_node_search():
    def __init__(self, number_inputs, number_outputs, num_in_hidden_layer_1):
    ...
    def find_optimal_hidden_node_1(self, start_number, max_number, step, dataset, positive_class_name):
        ...
        Searches for the second hidden layer
        """
        ...
        for node_number in node_numbers:
            ...
            nn = NeuralNetwork(self.number_inputs, self.number_outputs,
                               num_in_hidden_layer_1=self.num_in_hidden_layer_1,
                               num_in_hidden_layer_2=node_number)
...
print("Cancer")
node_search = hidden_layer1_node_search(90, 1, 5)
...
print("Soybean")
node_search = hidden_layer1_node_search(204, 1, 5)
...
print("Votes")
node_search = hidden_layer1_node_search(16, 1, 5)
...
print("Iris")
node_search = hidden_layer1_node_search(24, 1, 20)
...
print("Glass")
node_search = hidden_layer1_node_search(54, 1, 5)
